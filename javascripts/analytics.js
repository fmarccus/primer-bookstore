...
function render(doc) {
    ...
    <td style="background-color:#d6f2ce; font-weight:bold;">Php ${doc.data().selling_price.toFixed(2)}</td>
    <td style="background-color:#ffd4d8;">${doc.data().available} pcs</td>
    <td style="background-color:#ffffcc;"><span style="font-weight:bold; color:#25476D;">${((doc.data().available / doc.data().quantity) * 100).toFixed(2)}%</span></td>
    <td style="background-color:#cef2f0;">${doc.data().quantity_sold} pcs</td>
    <td style="background-color:#ffffcc;"><span style="font-weight:bold; color:#25476D;">${((doc.data().quantity_sold / doc.data().quantity) * 100).toFixed(2)}%</span></td>
    <td style="background-color:#d6f2ce; font-weight:bold;">Php ${doc.data().sales}</td>
    <td style="background-color:#ffffcc;"><span style="font-weight:bold; color:#25476D;">${((doc.data().sales / (doc.data().selling_price * doc.data().quantity)) * 100).toFixed(2)}%</span></td>
